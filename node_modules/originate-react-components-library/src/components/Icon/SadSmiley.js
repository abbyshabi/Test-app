...
const SadSmiley = props => (
  <svg viewBox="0 0 44 45" fill="none" {...props}>
    <path d="M0 44.98h44v-44H0v44z" fill="url(#prefix__pattern0)" />
    <defs>
      <pattern
        id="prefix__pattern0"
